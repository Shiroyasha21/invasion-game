...
This README is written as a walkthrough — read top to bottom and you'll
understand how to play, how the systems fit together, and where to find
things in the code.
...
- **Brute** / **Marksman** — bulldoze through anything in their path, then
  siege the tree once they arrive.
...
- **`Game`** (`scripts/systems/game.gd`) is the root orchestrator: wires
...
3. The mobile viewport is portrait (1080×1920); resize the editor window or
